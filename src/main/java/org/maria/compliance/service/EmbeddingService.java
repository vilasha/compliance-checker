...
public interface EmbeddingService {
    ...
    EmbeddingSearchResult searchSimilar(String queryText, int maxResults, double minScore);

    EmbeddingSearchResult searchSimilar(String queryText, int maxResults, double minScore, String language);
